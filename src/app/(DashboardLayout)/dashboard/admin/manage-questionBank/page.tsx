...
const filteredQuestions = questions.filter((q) => {
 ...
 useEffect(()=>{
    if(localStorage.getItem("LevelSelected")){
      setLevel(localStorage.getItem("LevelSelected")||"")
    }
        if(localStorage.getItem("CourseSelected")){
      setCourse(localStorage.getItem("CourseSelected")||"")
    }
        if(localStorage.getItem("SubjectSelected")){
      setSubject(localStorage.getItem("SubjectSelected")||"")
    }
        if(localStorage.getItem("ChapterSelected")){
      setChapter(localStorage.getItem("ChapterSelected")||"")
    }
  },[])
...
const handleLevelChange = (newLevel: string) => {
  setLevel(newLevel);
  localStorage.setItem("LevelSelected",newLevel)
};


const handleCourseChange = (newCourse: string) => {
  setCourse(newCourse);
  localStorage.setItem("CourseSelected",newCourse)
};

const handleSubjectChange = (newSubject: string) => {
  setSubject(newSubject);
  localStorage.setItem("SubjectSelected",newSubject)
};

const handleChapterChange = (newChapter: string) => {
  setChapter(newChapter);
  localStorage.setItem("ChapterSelected",newChapter)
};
